            ...
            <div className="space-y-6">
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                  ...
                  and contributed as Community Lead and Finance Manager for
                  almost three years. During this time I ran several scholarship
                  programs, gave over 20 Ethereum-focused talks and workshops,
                  and organized meetups across the country with two major events
                  with an attendance of over 600 people.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                  ...
                  trading, during my first two years I collaborated as
                  translator in BanklessDAO and shortly after I joined to
                  Cryptoversidad where I developed a course for newbies.
                </p>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                  ...
                  Designer for several companies in the heat exchanger industry.
                  I reduced 75% the production documentation process, improved
                  airflow & piping designs through FEA & CFD analysis. During my
                  experience at the University I mentored several students in
                  CAD software like Catia, SolidWorks and Nastran.
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200 dark:border-gray-700">
              <h4 className="text-xl font-bold text-gray-900 dark:text-white mb-2 flex items-center">
                <span className="mr-2">🔐</span> Node Operator
              </h4>
            ...
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-4">
                <div className="pl-4 border-l-4 border-blue-500 dark:border-blue-400">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                    A decentralized fundraising platform that empowers
                    communities to create and support local causes with complete
                    transparency using USDC on Base blockchain. I hacked solo,
                    built contracts by myself and the rest of the project was
                    vibecoded.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div className="pl-4 border-l-4 border-blue-500 dark:border-blue-400">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
                      ...
                      meaningful connections. My first hackathon as a dev. I
                      built the contracts and wallet integrations.
                    </p>
                  </div>
                </div>
